...
## %bb.0:                               ## %_ZN9benchmark5State13StateIteratorC2EPS0_.exit
	...
	.cfi_offset %r15, -24
	movq	%rdi, %rbx
	leaq	__ZTV14Rotary_encoder+16(%rip), %rax
	movq	%rax, -40(%rbp)
	movl	28(%rdi), %r14d
	movq	16(%rdi), %r15
	callq	__ZN9benchmark5State16StartKeepRunningEv
...
## %bb.1:                               ## %_ZN9benchmark5State13StateIteratorC2EPS0_.exit
	...
	je	LBB3_4
	.p2align	4, 0x90
LBB3_2:                                 ## %_ZN9benchmark5State13StateIteratorppEv.exit
                                        ## =>This Inner Loop Header: Depth=1
	movl	$42, -28(%rbp)
	## InlineAsm Start
	## InlineAsm End
...
## %bb.3:
	movq	-40(%rbp), %rdi
	callq	__ZdlPv
LBB9_4:                                 ## %__cxx_global_var_init.1.exit
...
## %bb.7:
	movq	-40(%rbp), %rdi
	callq	__ZdlPv
LBB9_8:                                 ## %__cxx_global_var_init.2.exit
...
## %bb.11:
	movq	-40(%rbp), %rdi
	callq	__ZdlPv
LBB9_12:                                ## %__cxx_global_var_init.4.exit
...
## %bb.15:
	movq	-40(%rbp), %rdi
	callq	__ZdlPv
LBB9_16:                                ## %__cxx_global_var_init.6.exit
...
LBB9_19:
	...
	testb	%r12b, %r12b
	je	LBB9_22
LBB9_21:                                ## %common.resume.sink.split
	movq	%rbx, %rdi
	callq	__ZdlPv
	movq	%r14, %rdi
	callq	__Unwind_Resume
